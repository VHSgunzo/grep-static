...
cp build/grep-${grep_version}/src/grep release 2>/dev/null
cp build/grep-${grep_version}/src/egrep release 2>/dev/null
cp build/grep-${grep_version}/src/fgrep release 2>/dev/null
